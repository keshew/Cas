...
class EmeraldMirageViewModel: ObservableObject {
    @Published var board: [[String]] = Array(repeating: Array(repeating: "mirage1", count: 5), count: 3)
...
//    
    let arrayOfImage = ["mirage1","mirage2","mirage3","mirage4","mirage5","mirage6","mirage7","mirage8","mirage9","mirage10"]
//    let arrayOfImage = ["mirage1","mirage2"]
    ...
    let multipliers: [String: [Int: Int]] = [
        "mirage1": [2: 10, 3: 100, 4: 1000, 5: 5000],
        "mirage2": [2: 5, 3: 40, 4: 400, 5: 2000],
        "mirage3": [2: 5, 3: 30, 4: 100, 5: 750],
        "mirage4": [2: 5, 3: 30, 4: 100, 5: 750],
        "mirage5": [3: 5, 4: 40, 5: 250],
        "mirage6": [3: 5, 4: 40, 5: 250],
        "mirage7": [3: 5, 4: 40, 5: 150],
        "mirage8": [3: 5, 4: 40, 5: 150],
        "mirage9": [3: 5, 4: 40, 5: 100],
        "mirage10": [3: 5, 4: 40, 5: 100]
    ]
}
