...
class VioletInfernoViewModel: ObservableObject {
    @Published var board: [[String]] = Array(repeating: Array(repeating: "inferno1", count: 5), count: 3)
    ...
    let arrayOfImage = ["inferno1","inferno2","inferno3","inferno4","inferno5","inferno6","inferno7","inferno8","inferno9", "inferno10"]
    ...
    let multipliers: [String: [Int: Int]] = [
        "inferno1": [2: 10, 3: 100, 4: 1000, 5: 5000],
        "inferno2": [2: 5, 3: 40, 4: 400, 5: 2000],
        "inferno3": [2: 5, 3: 30, 4: 100, 5: 750],
        "inferno4": [2: 5, 3: 30, 4: 100, 5: 750],
        "inferno5": [3: 5, 4: 40, 5: 250],
        "inferno6": [3: 5, 4: 40, 5: 250],
        "inferno7": [3: 5, 4: 40, 5: 150],
        "inferno8": [3: 5, 4: 40, 5: 150],
        "inferno9": [3: 5, 4: 40, 5: 100],
        "inferno10": [3: 5, 4: 40, 5: 100]
    ]
}
